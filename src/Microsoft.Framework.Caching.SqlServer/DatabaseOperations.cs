...
namespace Microsoft.Framework.Caching.SqlServer
{
    internal class DatabaseOperations : IDatabaseOperations
    {
        ...
        protected virtual byte[] GetCacheItem(string key, bool includeValue)
        {
            ...
            DateTimeOffset? absoluteExpirationUTC = null;
            ...
            using (var connection = new SqlConnection(ConnectionString))
            {
                ...
                if (reader.Read())
                {
                    ...
                    expirationTimeUTC = reader.GetFieldValue<DateTimeOffset>(Columns.Indexes.ExpiresAtTimeIndex);
                    ...
                    {
                        absoluteExpirationUTC = reader.GetFieldValue<DateTimeOffset>(
            ...
            UpdateCacheItemExpiration(
                key, utcNow, expirationTimeUTC, slidingExpiration, absoluteExpirationUTC);
